...
def new_make_labeled_video_according_to_frame(labels_list: Union[List, Tuple], frames_indices_list: Union[List, Tuple], output_file_name: str, video_source: str, current_behaviour_list: List[str] = [], output_fps=15, fourcc='mp4v', output_dir=config.EXAMPLE_VIDEOS_OUTPUT_PATH, **kwargs):
    """
    "NEW BECAUSE THIS IS FIRST ATTEMPT AT DECOUPLING TEXT/COLOUR FROM FRAME ITER"
