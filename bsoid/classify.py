...
def bsoid_frameshift_app(data_new, video_fps: int, clf_MLP):
    """
...
def main_py(predict_folders: List[str], scaler, fps, behv_model) -> Tuple[Any, Any, Any, Any]:
    ...
    """
    filenames, data_new, perc_rect = likelihoodprocessing.import_csvs_data_from_folders_in_BASEPATH(predict_folders)
