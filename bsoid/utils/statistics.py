...
def feat_dist(feats: np.ndarray) -> Tuple[List, List, List, List]:
    feat_range = []
    feat_med = []
    p_cts = []
    edges = []
...
def rle(inarray):  # TODO: rename function for clarity?
    """
...
### TODO: disambiguate between main()s
def main(labels, n):
    """
    :param labels: 1D array: predicted labels
    :param output_path: string, output directory  # TODO: low: missing param
    :return dur_stats: object, behavioral duration statistics data frame
